...
variable "enable_log_analytics_integration" {
  type        = bool
  default     = true
  description = "Enable integration with Azure Monitor/Log Analytics"
}

variable "enable_load_balancer_diagnostics" {
  type        = bool
  default     = true
  description = "Enable load balancer diagnostics (requires LA workspace and storage)"
}
