...
output "request_routing_rule_backend_address_pool_id" {
  ...
  value       = module.application_gateway.request_routing_rule_backend_address_pool_id
}
...
output "request_routing_rule_backend_http_settings_id" {
  ...
  value       = module.application_gateway.request_routing_rule_backend_http_settings_id
}
...
output "request_routing_rule_redirect_configuration_id" {
  ...
  value       = module.application_gateway.request_routing_rule_redirect_configuration_id
}
...
output "request_routing_rule_rewrite_rule_set_id" {
  ...
  value       = module.application_gateway.request_routing_rule_rewrite_rule_set_id
}

output "request_routing_rule_url_path_map_id" {
  description = "The ID of the Request Routing Rule associated URL Path Map"
  value       = module.application_gateway.request_routing_rule_url_path_map_id
}

output "ssl_certificate_id" {
  description = "The ID of the SSL Certificate"
  value       = module.application_gateway.ssl_certificate_id
}

output "ssl_certificate_public_cert_data" {
  description = "The Public Certificate Data associated with the SSL Certificate"
  value       = module.application_gateway.ssl_certificate_public_cert_data
}

output "url_path_map_id" {
  description = "The ID of the URL Path Map"
  value       = module.application_gateway.url_path_map_id
}
...
output "url_path_map_default_backend_address_pool_id" {
  ...
  value       = module.application_gateway.url_path_map_default_backend_address_pool_id
}
...
output "url_path_map_default_backend_http_settings_id" {
  ...
  value       = module.application_gateway.url_path_map_default_backend_http_settings_id
}
...
output "url_path_map_default_redirect_configuration_id" {
  ...
  value       = module.application_gateway.url_path_map_default_redirect_configuration_id
}

output "custom_error_configuration_id" {
  description = "The ID of the Custom Error Configuration"
  value       = module.application_gateway.custom_error_configuration_id
}

output "redirect_configuration_id" {
  description = "The ID of the Redirect Configuration"
  value       = module.application_gateway.redirect_configuration_id
}

output "rewrite_rule_set_id" {
  description = "The ID of the Rewrite Rule Set"
  value       = module.application_gateway.rewrite_rule_set_id
}