...
# lets attach policies to the role
...
# lets create controller policy and controller trust policy
...
# adding tags to the subnet and security groups
...
# getting values for node group and launch template
...
# add this in configmap ,change aws partition to aws and give account id
